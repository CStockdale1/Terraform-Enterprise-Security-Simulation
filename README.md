...
## Background
This project takes inspiration from my IT security internship I participated in during summer of 2026. While not an exact 1:1 copy, it takes a lot of aspects of the real world terraform infrastructure I came across working with the security engineering team.
...
- Logging security tests, which validates that security logging bucket exists, versioning is enabled, and server-side encryption is configured. 
